...
import { printInvoice as _printInvoice } from '../utils/printInvoice';
...
// ── Print invoice — thin wrapper that normalises data for the shared utility ───
const printInvoice = (bill, items, printWin = null) =>
  _printInvoice({
    invoiceNumber:          bill.invoice_number,
    billDate:               bill.bill_date,
    paymentStatus:          bill.payment_status,
    accessionNumber:        bill.accession_number,
    patientName:            bill.patient_name,
    pid:                    bill.pid,
    phone:                  bill.patient_phone,
    gender:                 bill.gender,
    dateOfBirth:            bill.date_of_birth,
    paymentMode:            bill.payment_mode,
    referringPhysicianName: bill.referring_physician_name,
    notes:                  bill.notes,
    itemDetailLabel:        'Modality',
    items: (items || []).map(s => ({ name: s.study_name, detail: s.modality || '—', amount: s.amount })),
