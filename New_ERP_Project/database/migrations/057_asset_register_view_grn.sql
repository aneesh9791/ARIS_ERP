-- ============================================================
-- Migration 057: Add GRN columns to asset_register_view
-- Replaces po_id/po_number with grn_id/grn_number so the
-- Asset Management UI can trace back to the GRN receipt.
-- ============================================================
