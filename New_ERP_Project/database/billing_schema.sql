-- BILLING MODULE DATABASE SCHEMA FOR KERALA, INDIA
...
-- EXPENSES TABLE (Updated for Indian context)
...
-- Sample data for Kerala, India context

-- Bank accounts (Indian banks)
INSERT INTO bank_accounts (
  account_name, account_number, bank_name, branch_name, ifsc_code,
  account_type, center_id, opening_balance, current_balance
) VALUES
('Main Operating Account', '1234567890123456', 'State Bank of India', 'Kochi Main Branch', 'SBIN0000001',
 'CURRENT', 1, 1000000.00, 1000000.00),
('Petty Cash Account', '9876543210987654', 'Federal Bank', 'Ernakulam Branch', 'FDRL0000001',
 'SAVINGS', 1, 50000.00, 50000.00),
('Salary Account', '5678901234567890', 'ICICI Bank', 'Thrissur Branch', 'ICIC0000001',
 'CURRENT', 1, 200000.00, 200000.00);

-- Consumables (Indian medical consumables)
...
('VENDOR001', 'Medtronic Healthcare Pvt Ltd', 'CONSUMABLES', '29AAAPM1234C1ZV', 'AAAPM1234C',
  '+91-484-1234567', 'kerala@medtronic.com', '123 Industrial Area, Kakkanad', 'Kochi', 'Kerala', '682030',
  'Rahul Sharma', '30 DAYS', '1234567890123456', 'HDFC Bank', 'HDFC0000001'),
('VENDOR002', 'GE Healthcare India', 'EQUIPMENT', '29AAAGE1234C1ZV', 'AAAGE1234C',
  '+91-484-2345678', 'orders@gehealthcare.in', '456 Tech Park, Infopark', 'Kochi', 'Kerala', '682042',
  'Priya Nair', '45 DAYS', '2345678901234567', 'ICICI Bank', 'ICIC0000001'),
('VENDOR003', 'Siemens Healthineers', 'EQUIPMENT', '29AAASI1234C1ZV', 'AAASI1234C',
  '+91-484-3456789', 'india@siemens.com', '789 Business Hub, Technopark', 'Trivandrum', 'Kerala', '695581',
  'Anil Kumar', '60 DAYS', '3456789012345678', 'Axis Bank', 'UTIB0000001'),
('VENDOR004', 'Kerala Medical Supplies', 'CONSUMABLES', '29AAAKS1234C1ZV', 'AAAKS1234C',
  '+91-484-4567890', 'info@keralamedical.com', '321 Market Road, Calicut', 'Kozhikode', 'Kerala', '673001',
  'Suresh Menon', '15 DAYS', '4567890123456789', 'Federal Bank', 'FDRL0000001'),
('VENDOR005', 'Philips India Ltd', 'EQUIPMENT', '29AAAPH1234C1ZV', 'AAAPH1234C',
  '+91-484-5678901', 'orders@philips.in', '654 Medical Plaza, Thrissur', 'Thrissur', 'Kerala', '680001',
  'Divya Krishnan', '30 DAYS', '5678901234567890', 'Canara Bank', 'CNRB0000001');

-- Expense categories for Indian diagnostic centers
...
('EXP001', 1, 'RENT', 'OFFICE_RENT', 'Monthly rent for diagnostic center', 50000.00,
 0, 0, 50000.00, '2024-03-01', 'BANK_TRANSFER', 'Rent for March 2024'),
('EXP002', 1, 'UTILITIES', 'ELECTRICITY', 'Electricity bill for March', 15000.00,
 0.05, 750.00, 15750.00, '2024-03-05', 'BANK_TRANSFER', 'KSEB electricity bill'),
('EXP003', 1, 'UTILITIES', 'WATER', 'Water bill for March', 2000.00,
 0.18, 360.00, 2360.00, '2024-03-05', 'BANK_TRANSFER', 'Kerala Water Authority'),
('EXP004', 1, 'SALARIES', 'STAFF_SALARY', 'Staff salaries for March', 250000.00,
 0, 0, 250000.00, '2024-03-31', 'BANK_TRANSFER', 'Monthly staff salaries'),
('EXP005', 1, 'MAINTENANCE', 'EQUIPMENT_MAINTENANCE', 'Annual MRI maintenance contract', 120000.00,
 0.18, 21600.00, 141600.00, '2024-03-15', 'BANK_TRANSFER', 'Siemens maintenance contract'),
('EXP006', 1, 'MARKETING', 'ADVERTISEMENT', 'Local newspaper advertisement', 5000.00,
 0.05, 250.00, 5250.00, '2024-03-10', 'CASH', 'Malayala Manam advertisement'),
('EXP007', 1, 'OFFICE', 'STATIONERY', 'Office stationery and supplies', 3500.00,
 0.18, 630.00, 4130.00, '2024-03-08', 'CASH', 'Monthly stationery purchase'),
('EXP008', 1, 'INSURANCE', 'LIABILITY_INSURANCE', 'Professional liability insurance', 25000.00,
 0.18, 4500.00, 29500.00, '2024-03-20', 'BANK_TRANSFER', 'Annual insurance premium');

-- Create indexes for performance
CREATE INDEX idx_patient_bills_center_date ON patient_bills(center_id, bill_date);
CREATE INDEX idx_vendor_bills_center_date ON vendor_bills(center_id, bill_date);
CREATE INDEX idx_consumable_stock_center_item ON consumable_stock(center_id, item_code);
CREATE INDEX idx_expenses_center_date ON expenses(center_id, expense_date);
...
CREATE INDEX idx_bank_accounts_center_id ON bank_accounts(center_id);
